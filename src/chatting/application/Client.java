...
public class Client implements ActionListener {
    ...
    Client() {
        ...
        morevert.setBounds(385, 20, 10, 25);
        p1.add(morevert);

        JLabel name = new JLabel("Mamun Mia");
        ...
        text.setFont(new Font("SSAN_SERIF", Font.PLAIN, 16));
        f.add(text);
        ...
        send.setFont(new Font("SSAN_SERIF", Font.PLAIN, 16));
        f.add(send);
    ...
    public static JPanel formatLabel(String out) {
        ...
        JLabel output = new JLabel("<html><p style=\"with: 150px\">" + out + "</p></html>");
